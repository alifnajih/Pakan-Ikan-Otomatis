...
void gerakkanservo() {
    ...
    static int servoState = 0; // 0 for 90 degrees, 1 for 0 degrees
    unsigned long currentMillis = millis();

    if (currentMillis - previousMillisServo >= 1500) { // interval for servo movement
        ...
        if (servoState == 0) {
            ...
            servo1.write(90);  // Move back to 90 degrees
            servoState = 0;
        }
    }
}
