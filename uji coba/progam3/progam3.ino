...
// Kalibrasi nilai faktor konversi dari tegangan ke ppm (TDS)
float conversionFactor = 0.5; // Faktor ini bisa bervariasi, tergantung dari sensor yang digunakan
...
if(kolam < 50){
 ...
 tds = (voltage / conversionFactor) * 1000;
